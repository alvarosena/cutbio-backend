    ...
    execute(id, file) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (user === null || user === void 0 ? void 0 : user.avatar_url) {
                yield this.s3StorageProvider.delete(user.avatar_url);
            }
            const newAvatar = yield this.s3StorageProvider.save(file);
            const avatar_url = `${process.env.AWS_BUCKET_URL}/${newAvatar}`;
            const userUpdated = yield this.usersRepository.updateAvatar(id, avatar_url);
            return userUpdated;
        });
    }
};
