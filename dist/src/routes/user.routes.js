...
const updateAvatarController = new UpdateAvatarController_1.UpdateAvatarController();
...
exports.usersRoutes.patch('/profile/avatar', uploadAvatar.single('avatar'), ensureAuthenticated_1.ensureAuthenticated, updateAvatarController.handle);
